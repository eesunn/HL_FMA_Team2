...
class LaneDetectorNode(Node):
    ...
    def __init__(self):
        ...
        _default_blob = os.path.join(
            ...
            'models', 'best_openvino_2022.1_6shave1.blob'
        )
        ...
        # 시간 필터 파라미터
        self.declare_parameter('ema_alpha', 0.4)   # EMA 반응속도 (0=완전 평균, 1=필터 없음)
        ...
        self.declare_parameter('poly_degree', 1)      # 1=직선(주행 안정) / 2=곡률 실험용
        ...
        self.declare_parameter('max_poly_slope', 3.0)      # ROI 내 다항식 기울기 최대 절댓값
        ...
        # 단일 차선 중심 복원 파라미터
        self.declare_parameter('single_lane_half_width_top', 160.0)
        self.declare_parameter('single_lane_half_width_bottom', 160.0)
